...
```console
helm install product-mongodb-sharded ./helm
```

```console
export MONGODB_ROOT_PASSWORD=$(kubectl get secret --namespace default product-mongodb-sharded -o jsonpath="{.data.mongodb-root-password}" | base64 -d)
```
